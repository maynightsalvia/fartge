...
\titleformat{\section}
	{\LARGE}{\textbf{\llap{\secmark\hspace{0.2cm}}Chapter \thesection}\\}{1em}{}
\titlespacing{\section}
	{0pc}{3.5ex plus 0.1ex minus 0.2ex}{1.5ex minus .1ex}
\titlecontents{section}[0.907935355cm]{}
	{\Large\contentslabel[\textit{\textbf{\llap{\secmark}\thecontentslabel}}]{0.9cm}}{}{}

\titleformat{\subsection}
	{\Large}{\textbf{\llap{\secmark\hspace{0.2cm}}\thesubsection}}{1em}{}
\titlespacing{\subsection}
	{0pc}{3.5ex plus 0.1ex minus 0.2ex}{1.5ex minus .1ex}
\titlecontents{subsection}[1.7cm]{}
	{\contentslabel[\textit{\llap{\secmark}\thecontentslabel}]{1cm}}{}{}

\titleformat{\subsubsection}
	{\large}{\textbf{\llap{\secmark}\thesubsubsection}}{2em}{}
\titlespacing{\subsubsection}
	{3pc}{3.5ex plus 0.1ex minus 0.2ex}{1.5ex minus .1ex}
\titlecontents{subsubsection}[2.75cm]{}
	{\contentslabel[\textit{\llap{\secmark}\thecontentslabel}]{1.3cm}}{}{}
\begin{document}
\maketitle
\newpage
...
\setlength{\headsep}{0.5cm}
\subsection{Foreword}
\normalsize \indent afasdjf;dskafdklfasf\vspace{0.6cm}\\
Until then,\\
Austin Kim\\
Philadelphia, PA\\
08 May, 2026
...
Before we begin the our work on defining numbers, it is important to ask why we should care at all about the particular labor that we are about to undertake. This is a fairly good habit; a student should always ask why we should care about anything that follows. It highlights the importance of what we are learning, and a good answer to such a question will also define a relation between things that we already know and the things we are about to learn.\par
...
\subsection{Natural and Whole Numbers}
...
\subsection{Integers and a Few Useful Words}
...
\subsubsection{Let's Talk About Fractions and Decimals!}
...
\subsection{A Few Diagrams for the Visual Learner}
...
\subsection{Some Forbidden Numbers: The Irrational Number System}
...
\subsubsection{Addition on Fractions}
...
\subsubsection{Addition on Decimals}
...
\subsubsection{Subtraction of Decimals}
...
\subsubsection{Multiplication on Integers}
...
\begin{center}
	...
	\end{tabular}
\end{center}
\subsubsection{Multiplication on Fractions}
...
\begin{formula}[(Multiplication of Fractions)]
	...
	\end{center}
\end{formula}
\subsubsection{Multiplication on Rational Decimals}
...
\subsubsection{Division on Integers}
...
\section{Geometric Techniques}
\subsection{Area of Figures}
aaaa
\begin{figure}[htbp]
	\centering
	\begin{tikzpicture}
...
\subsection{Exponents and Exponentiation}
\subsection{The Logarithm}
\subsection{Factorials}
\subsubsection{A Note on the Uncharted Path: Combinatorics}

\section{Building Blocks of Higher-Level Mathematics: Set Theory}
\subsection{Sets and Useful Notation}
\subsection{How to Make Sets Marry: Union and Intersection}
\subsection{Mortal Enemies: Complements and Differences}
\subsection{A Justification for Proofs and Logic (Why You Should Care)}

\section{Functions}
\subsection{A Machine That Gives You Only One Result}
\subsection{Killing Everything As We Go: Surjective/Onto Functions}
\subsection{Loyalty: Injective/One-to-One Functions}
\subsection{A Backward Function...? Inverses and Pre-Images}

\begin{advanced}
\section{The Flavour of Mathematical Analysis: Limits and the Infinitesimal}
\subsection{Are We There Yet? The Limit}
\subsection{Distances, Open Sets, and Numbers That Bind}
\subsubsection{How Far is Something? Metric Spaces}
\subsection{Closed Sets}
\subsection{Compact Sets}
\subsubsection{The Heine-Borel Theorem}
\subsection{A Long Chain: Sequences and Series}
\subsubsection{The Bolzano-Weierstrass Theorem}
\subsection{Useful Notation and Remarks on Their Intuition}
\subsection{Good Enough: Continuity and Continuous Functions}
\subsection{Real Numbers: Filling the Blanks}
\end{advanced}
\newpage

\section{More on Geometry: Curves, Area, and Sums}

\section{Descending Down the Staircase: Derivation, the \mbox{Integral,} and the \mbox{Fundamental} Theorem of Calculus}
\subsection{Rates of Change}
\subsection{The Derivative}

\section{What Now?}
\subsection{Descriptions of Further Mathematics}
\subsubsection{Mathematical Analysis}
\subsubsection{Applied Mathematics}
\begin{advanced}\subsubsection{Algebra}\end{advanced}
\subsubsection{Number Theory}
\subsubsection{Topology}
\subsubsection{Geometry}
\subsection{The Love of the Game}
\subsection{Competition Mathematics}
\begin{advanced}\subsection{A Final Remark}\end{advanced}
\newpage
